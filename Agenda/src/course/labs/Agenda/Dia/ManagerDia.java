package course.labs.Agenda.Dia;
...
public class ManagerDia extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState)
    {
		...
		setContentView(R.layout.fragment_dia);
...
//
//           for (int c = 0; c < 5;c++) valores_totales[c-2] += Integer.parseInt(datos[f][c]);
//           
//
//           tabla.addView(fila);
//        }
